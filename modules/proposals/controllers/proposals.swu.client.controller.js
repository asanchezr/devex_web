(function () {
	...
	.controller ('ProposalEditSWUController', [
		...
		'TINYMCE_OPTIONS',
		'resources',
		function (capabilities, editing, $scope, $sce, ask, Upload, $state, proposal, opportunity, Authentication, ProposalsService, Notification, dataService, CapabilitiesMethods, org, TINYMCE_OPTIONS, resources) {
			var ppp                                   = this;
			var _init = function () {
