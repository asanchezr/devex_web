(function () {
  ...
  function AuthenticationController($scope, $rootScope, $state, usercount, UsersService, $location, $window, Authentication, PasswordValidator, Notification) {
	...
	//   $window.location.href = window.apiUrl + '/api/auth/github';

		$window.location.href = 'https://github.com/login/oauth/authorize?client_id=41ccce0baed7339372cd';
	}
