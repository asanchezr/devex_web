(function () {
	...
	// =========================================================================
	//
	// Controller for the master list of proposalQuestions
	//
	// =========================================================================
	.controller ('PropsalQuestionsListController', function (proposalQuestions) {
		var vm         = this;
		vm.proposalQuestions = proposalQuestions;
	})
	// =========================================================================
	//
	...
	.controller ('PropsalQuestionEditController', function ($scope, $state, propsalQuestion, Authentication, Notification) {
		...
		qqq.savenow = function (isValid, leavenow) {
			...
			.then (function (result) {
				...
				if (leavenow) $state.go ('proposalQuestions.view', {propsalQuestionId:qqq.propsalQuestion.code});
			})
			//
